...
<body class="hold-transition login-page " style="background-image:url('<?php echo base_url(); ?>uploads/systemimgs/business-3528035_1280.jpg'); background-size:cover; position: relative;">
    <br /><br /><br /><br /> <br />
    <div class="col-md-4 col-md-offset-4" style="border:1px solid gray; background: rgba(40, 41, 41, 0.48); padding:10px; border-radius:7px;">
        ...
        <h3 class="text-center" style="font-family: cursive;">
            <a href="<?php echo base_url('login'); ?>"> <b style="color:#faffbd;">D&A Accounting </b></a>
        </h3>
